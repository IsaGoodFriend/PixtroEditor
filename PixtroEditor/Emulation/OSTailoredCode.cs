...
#endif
{
	public static class OSTailoredCode
	{
		...
		private static readonly Lazy<bool> _isWSL = new Lazy<bool>(() => IsUnixHost && SimpleSubshell("uname", "-r", "missing uname?").Contains("microsoft", StringComparison.InvariantCultureIgnoreCase));
